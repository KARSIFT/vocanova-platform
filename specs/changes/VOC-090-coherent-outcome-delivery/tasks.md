...
- Requirements: `VOC-090-D00` through `VOC-090-D13`
- Acceptance criteria: `VOC-090-AC-00` through `VOC-090-AC-06`
...
the default for one coherent outcome; define task IDs as minimum-sufficient
traceability/evidence groupings; replace fixed line-count splitting mandates with
outcome/risk/rollback/dependency/reviewer/reviewability signals; and require an
overhead-aware written rationale for every multi-PR plan.
