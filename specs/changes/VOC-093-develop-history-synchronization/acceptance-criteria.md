...
- Requirements: `VOC-093-D00`, `D10`, `D12`
- Task: `VOC-093-T00`
...
- Requirements: `VOC-093-D01`, `D02`, `D03`, `D08`
- Task: `VOC-093-T00`
...
- Requirements: `VOC-093-D04`, `D05`, `D06`, `D11`
- Task: `VOC-093-T00`
...
deployment is triggered by repository history alone, no settings action is part of
this package, and only GitHub's existing automatic deletion of merged short-lived plan
or implementation heads may occur.

## VOC-093-AC-03 — A deterministic guard prevents future omission of the boundary

- Requirements: `VOC-093-D07`
- Task: `VOC-093-T00`
...
## VOC-093-AC-04 — Existing dirty and recovery state remains preserved, and only merged short-lived heads may auto-delete

- Requirements: `VOC-093-D09`, `D11`
- Task: `VOC-093-T00`
...
remain present. No manual branch deletion, no permanent-branch deletion, no worktree
removal, no settings mutation, no deployment, and no other live external action
occurs. If GitHub automatically deletes the merged short-lived plan or implementation
source head under the current `delete_branch_on_merge=true` setting, the exact
pre-merge SHA, post-merge readback, and recreate command are attached.
