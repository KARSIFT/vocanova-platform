...
| ---------------------------------------------------- | ----------------- | -------------------------------------------------- | --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `apps/web/src/app/(app)/home/page.tsx`               | VOC-019 / VOC-026 | `MOCK_HOME_STATE.dueReviewWords`                   | **Option (a): decommission → real P2;** **or (b): retain mock-pending-P2** | Per `D05`. Wired to `GET /api/v1/reviews/due` count, or explicitly left mock with an updated "P2-pending" comment. The mission target, reviewed-today count, and streak stay mock-pending-P4. |
