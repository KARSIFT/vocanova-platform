...
via Playwright, per DOC-08) is a required follow-up (`VOC-016-D08`/`DEP-05`), not
part of this shell. No secrets or production data are used by any test.

## VOC-016-TEST-00 — Three tab routes resolve with placeholder content

- Covers: `VOC-016-AC-00`
- Preconditions: `VOC-016-T00` steps 1–3 complete.
- Procedure:
...
## VOC-016-TEST-01 — Persistent bottom navigation on every tab route
...
## VOC-016-TEST-02 — Accessibility and mobile-first checklist

- Covers: `VOC-016-AC-02`, `VOC-016-AC-03`
- Preconditions: `VOC-016-T00` complete.
...
- Expected result: all six checks hold (DOC-03 §7/§10/§12, DOC-08 Quality
  ...
  inspection, not automated axe assertions (`VOC-016-D08`).
- Evidence: `VOC-016-EV-02`

## VOC-016-TEST-03 — Deterministic check suite passes

- Covers: `VOC-016-AC-04`
- Preconditions: all `VOC-016-T00` steps complete.
