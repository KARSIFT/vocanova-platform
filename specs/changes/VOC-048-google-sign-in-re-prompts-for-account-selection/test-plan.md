...
## VOC-048-TEST-00 — App-level session persistence, isolated from Google's prompt behavior

- Covers: `VOC-048-AC-00`
...
## VOC-048-TEST-01 — No re-prompt for an already-authorized, currently-signed-in user

- Covers: `VOC-048-AC-01`
- Preconditions: `VOC-048-T01` implemented per the chosen replacement
...
## VOC-048-TEST-02 — Explicit sign-out still requires a genuine OAuth round-trip

- Covers: `VOC-048-AC-02`
- Preconditions: `VOC-048-T01` implemented; a previously signed-in test
  session.
...
## VOC-048-TEST-03 — CSRF state-token check is unaffected

- Covers: `VOC-048-AC-03`
- Preconditions: `VOC-048-T01` implemented.
...
## VOC-048-TEST-04 — `email_verified` freshness trade-off is explicit, not silently dropped

- Covers: `VOC-048-AC-04`
- Preconditions: `VOC-048-T01` implemented.
