...
unchanged in effect. Bind the real candidate to exact base, the fixed sorted 12 paths,
the exact path-NUL/blob-OID-no-LF-NUL command, and digest
`7205f4856b2839f7302ab9a9fd9fbac57ee69942723f283241ac2970bb147e43` before/after
reproduction and observation; keep `8efd149c...` as superseded history only. Complete
deterministic/rollback evidence, obtain specialist and independent exact-SHA reviews,
and observe the first real VOC-105 candidate. Do not edit the runtime validator or
