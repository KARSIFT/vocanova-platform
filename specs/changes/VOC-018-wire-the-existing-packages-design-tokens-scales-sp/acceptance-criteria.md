# VOC-018 — Acceptance Criteria

Criteria are observable and bidirectionally traceable to decisions
`VOC-018-D00`..`D04`, tasks `VOC-018-T00`..`T02`, tests `VOC-018-TEST-00`..`04`,
and evidence `VOC-018-EV-00`..`04`. "Emitted custom property" means the property
appears in the CSS Tailwind compiles for `apps/web` (i.e. resolvable as
`var(--…)` on `:root` in the built output).

## VOC-018-AC-00 — `@vocanova/design-tokens` is importable and depended on

- Requirement source: `VOC-018-D00`
- Tasks: `VOC-018-T00`
- Tests: `VOC-018-TEST-00`
...
## VOC-018-AC-01 — All eight scales are emitted as Tailwind v4 @theme custom properties

- Requirement source: `VOC-018-D01`
- Tasks: `VOC-018-T01`
...
## VOC-018-AC-02 — Tokens are consumable by components

- Requirement source: `VOC-018-D01`, `VOC-018-D04`
- Tasks: `VOC-018-T01`
- Tests: `VOC-018-TEST-02`
- Evidence: `VOC-018-EV-01`
- Result: pending
...
consumption; no `duration-<name>` utility class is asserted (`VOC-018-D01`).

## VOC-018-AC-03 — Drift check binds the CSS to the TS tokens and is enforced by CI

- Requirement source: `VOC-018-D00`, `VOC-018-D03`
- Tasks: `VOC-018-T02`
- Tests: `VOC-018-TEST-03`
...
(and, for the generation design of `VOC-018-D00`, when the committed CSS differs
...
## VOC-018-AC-04 — Deterministic checks pass and no UI surface is added

- Requirement source: `VOC-018-D00`
- Tasks: `VOC-018-T00`, `VOC-018-T01`, `VOC-018-T02`
- Tests: `VOC-018-TEST-04`
