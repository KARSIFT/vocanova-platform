# VOC-044 — Server-Rendered Pages' Own /api/v1/me Check Fails with 401 Immediately After middleware.ts's Identical Check Succeeds
...
4. Adopt (or request changes to) this package, then dispatch `VOC-044-T00`
   through `VOC-044-T01` individually, as prior packages' tasks were dispatched
   one at a time.
