...
## VOC-044-T00 — Forward the raw incoming Cookie header from api-server.ts, matching middleware.ts

- Requirement source: issue #333's "likely area to investigate" and "suggested
  fix direction"
- Acceptance criteria: `VOC-044-AC-00`, `VOC-044-AC-01`
- Status: pending
...
## VOC-044-T01 — Deterministic regression test for cookie-forwarding divergence
...
- Acceptance criteria: `VOC-044-AC-02`
- Status: pending
- Depends on: `VOC-044-T00` (or may be written first as a failing-first test
