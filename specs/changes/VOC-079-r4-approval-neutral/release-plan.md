...
3. Add the local, read-only eligibility evaluator and GitHub evidence adapter, then
   reconcile canonical authority, enforcement, and package templates without an
