        ...
        <div className="mt-[var(--spacing-sm)]">
          ...
          {searchFailed ? (
            <button
              ...
              disabled={isLoading}
              aria-busy={isLoading}
              className="mt-[var(--spacing-sm)] inline-flex min-h-[var(--spacing-2xl)] items-center rounded-md border border-neutral-300 bg-white px-[var(--spacing-md)] py-[var(--spacing-sm)] text-base font-medium text-neutral-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
              Try search again
            </button>
          ) : null}
