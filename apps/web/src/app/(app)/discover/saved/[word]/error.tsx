...
interface SavedWordErrorProps {
  error: Error & { digest?: string };
  reset: () => void;
}

export default function SavedWordError({ reset }: SavedWordErrorProps) {
  ...
  return (
    <div className="p-[var(--spacing-lg)]">
      <h1 className="text-xl font-semibold text-neutral-900">
        We couldn&apos;t load this saved word
      </h1>
      <p className="mt-[var(--spacing-sm)] text-base text-neutral-700">
        Please try again. Your saved vocabulary and review progress are still
        safe.
      </p>
