/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 3a467d8457296809a706b1ad988cbb0b)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
  ASSETS: Fetcher;
  ENVIRONMENT: "staging" | "production" | "local";
  API:
    | Fetcher /* vocanova-api-staging */
    | Fetcher /* vocanova-api-production */
    | Fetcher /* vocanova-api-local */;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./sentry.edge.config");
  }
  interface StagingEnv {
    ASSETS: Fetcher;
    ENVIRONMENT: "staging";
    API: Fetcher /* vocanova-api-staging */;
  }
  interface ProductionEnv {
    ASSETS: Fetcher;
    ENVIRONMENT: "production";
    API: Fetcher /* vocanova-api-production */;
  }
