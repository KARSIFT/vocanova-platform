/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 687d4d7865bd85b32a6bbaf1619ff0e3)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ENVIRONMENT: "staging" | "production" | "local";
	RELEASE: "prepared" | "held" | "local";
	CORS_ALLOWED_ORIGINS: "https://stag.vocanova.site" | "https://web-production.invalid" | "http://127.0.0.1:3000";
	AUTH_BASE_URL: "https://stag.vocanova.site" | "https://web-production.invalid" | "http://127.0.0.1:3000";
	OAUTH_REDIRECT_URI: "https://api-stag.vocanova.site/api/v1/auth/oauth/google/callback" | "https://api-production.invalid/api/v1/auth/oauth/google/callback" | "http://127.0.0.1:8080/api/v1/auth/oauth/google/callback";
	OAUTH_RETURN_ALLOWLIST: "https://stag.vocanova.site/home,https://stag.vocanova.site/onboarding" | "https://web-production.invalid/home,https://web-production.invalid/onboarding" | "http://127.0.0.1:3000/home,http://127.0.0.1:3000/onboarding";
	EMAIL_PROVIDER_URL: "";
	EMAIL_FROM: "";
	AUTH_PROVIDER_TIMEOUT_MS: "8000";
	GOOGLE_OAUTH_CLIENT_ID: "";
	MAGIC_LINK_ENABLED: "false" | "true";
	GOOGLE_OAUTH_ENABLED: "false";
	NEW_USER_SIGNUP_ENABLED: "false" | "true";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ENVIRONMENT: "staging";
		RELEASE: "prepared";
		CORS_ALLOWED_ORIGINS: "https://stag.vocanova.site";
		AUTH_BASE_URL: "https://stag.vocanova.site";
		OAUTH_REDIRECT_URI: "https://api-stag.vocanova.site/api/v1/auth/oauth/google/callback";
		OAUTH_RETURN_ALLOWLIST: "https://stag.vocanova.site/home,https://stag.vocanova.site/onboarding";
		EMAIL_PROVIDER_URL: "";
		EMAIL_FROM: "";
		AUTH_PROVIDER_TIMEOUT_MS: "8000";
		GOOGLE_OAUTH_CLIENT_ID: "";
	...
	interface ProductionEnv {
		...
		RELEASE: "held";
		CORS_ALLOWED_ORIGINS: "https://web-production.invalid";
		AUTH_BASE_URL: "https://web-production.invalid";
		OAUTH_REDIRECT_URI: "https://api-production.invalid/api/v1/auth/oauth/google/callback";
		OAUTH_RETURN_ALLOWLIST: "https://web-production.invalid/home,https://web-production.invalid/onboarding";
		EMAIL_PROVIDER_URL: "";
		EMAIL_FROM: "";
		AUTH_PROVIDER_TIMEOUT_MS: "8000";
		GOOGLE_OAUTH_CLIENT_ID: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "RELEASE" | "CORS_ALLOWED_ORIGINS" | "AUTH_BASE_URL" | "OAUTH_REDIRECT_URI" | "OAUTH_RETURN_ALLOWLIST" | "EMAIL_PROVIDER_URL" | "EMAIL_FROM" | "AUTH_PROVIDER_TIMEOUT_MS" | "GOOGLE_OAUTH_CLIENT_ID" | "MAGIC_LINK_ENABLED" | "GOOGLE_OAUTH_ENABLED" | "NEW_USER_SIGNUP_ENABLED" | "NEW_USER_SIGNUP_ALLOWLIST" | "RESERVED_SYNTHETIC_EMAIL" | "AI_GENERATION_ENABLED" | "AI_PER_MINUTE" | "AI_PER_DAY" | "AI_GLOBAL_PER_DAY" | "AI_MONTHLY_COST_HARD_STOP_CENTS" | "AI_REQUEST_COST_CENTS" | "AI_GENERATION_LEASE_SECONDS" | "AI_PROVIDER_TIMEOUT_MS">> {}
}
