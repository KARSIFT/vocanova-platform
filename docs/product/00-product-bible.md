...
- **Streak** — advances only after a full daily mission is completed, uses the learner's local
  ...
  every 7 completed days, capped at a balance of 2. Learners can confirm or change their IANA
  timezone in onboarding and Settings; it sets future daily reset boundaries.
